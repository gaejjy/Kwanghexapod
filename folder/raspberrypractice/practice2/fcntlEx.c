...
int main(void)
{
	...
	switch(flag & O_ACCMODE){
	   	case O_RDONLY: printf("O_RDONLY flag is set.\n");
					   break;
	   	case O_WRONLY: printf("O_WRONLY flag is set.\n");
					   break;
	   	case O_RDWR: printf("O_RDWR flag is set.\n");
					 break;
	   	default: printf("unknown accemode");
				 break;
   	}
